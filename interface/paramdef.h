...
OUTPUT(VCF1_L_LIN, 	    P12_1,	0,	    INT,	0x31, 	LIN,	0)
OUTPUT(VCF2_L_LIN,	    P12_1,	1,	    INT,	0x32, 	LIN,	0)
OUTPUT(CLEANF_L_LIN,    P12_1,  2,      INT,	0x33, 	LIN,	0)
OUTPUT(VCF1_L_LOG,      P12_1,  3,      INT,	0x34, 	LOG,	0)
OUTPUT(VCF2_L_LOG,      P12_1,  4,      INT,	0x35, 	LOG,	0)
OUTPUT(CLEANF_L_LOG,    P12_1,  5,      INT,	0x36, 	LOG,	0)
OUTPUT(VCF1_R_LIN,      P12_1,  6,      INT,	0x37, 	LIN,	0)
OUTPUT(VCF2_R_LIN,      P12_1,  7,      INT,	0x38, 	LIN,	0)
OUTPUT(CLEANF_R_LIN,    P12_1,  8,      INT,	0x39, 	LIN,	0)
OUTPUT(VCF1_R_LOG,      P12_1,  9,     	INT,	0x3A, 	LOG,	0)
OUTPUT(VCF2_R_LOG,      P12_1,  10,     INT,	0x3B, 	LOG,	0)
OUTPUT(CLEANF_R_LOG,    P12_1,  11,     INT,	0x3C, 	LOG,	0)
...
OUTPUT(VCO1_MIX2,       P20_1,  5,      CTRL,	0x46, 	LOG,	0)
OUTPUT(VCO2_MIX2,       P20_1,  6,      CTRL,	0x47, 	LOG,	0)
OUTPUT(VCO3_MIX2,       P20_1,  7,      CTRL,	0x48, 	LOG,	0)
OUTPUT(RM1_MIX2,        P20_1,  8,      CTRL,	0x49, 	LOG,	0)
OUTPUT(VCO1_MIX1,       P20_1,  9,     	CTRL,	0x4A, 	LOG,	0)
OUTPUT(VCO2_MIX1,       P20_1,  10,     CTRL,	0x4B, 	LOG,	0)
OUTPUT(VCO3_MIX1,       P20_1,  11,     CTRL,	0x4C, 	LOG,	0)
OUTPUT(RM1_MIX1,        P20_1,  12,     CTRL,	0x4D, 	LOG,	0)

OUTPUT(PUN_MIX,      	P20_0,  0,      CTRL,	0x61, 	LOG,	0)
OUTPUT(VCO4_DRY_MIX,    P20_0,  1,      CTRL,	0x62, 	LOG,	0)
OUTPUT(VCO6_DRY_MIX,    P20_0,  2,      CTRL,	0x63, 	LOG,	0)
OUTPUT(VCO4567_MIX2,    P20_0,  3,      CTRL,	0x64, 	LOG,	0)
OUTPUT(WHITENS_MIX1,    P20_0,  4,      CTRL,	0x65, 	LOG,	0)
OUTPUT(DIGINS_MIX1,     P20_0,  5,      CTRL,	0x66, 	LOG,	0)
OUTPUT(EXT_MIX1,        P20_0,  6,      CTRL,	0x67, 	LOG,	0)
OUTPUT(RM2_MIX3,        P20_0,  7,      CTRL,	0x68, 	LOG,	0)
OUTPUT(BN_MIX3,         P20_0,  8,      CTRL,	0x69, 	LOG,	0)
OUTPUT(VCO5_DRY_MIX,    P20_0,  9,     	CTRL,	0x6A, 	LOG,	0)
OUTPUT(VCO7_DRY_MIX,    P20_0,  10,     CTRL,	0x6B, 	LOG,	0)
OUTPUT(VCO4567_MIX1,    P20_0,  11,     CTRL,	0x6C, 	LOG,	0)
OUTPUT(WHITENS_MIX2,    P20_0,  12,     CTRL,	0x6D, 	LOG,	0)
OUTPUT(DIGINS_MIX2,     P20_0,  13,     CTRL,	0x6E, 	LOG,	0)
OUTPUT(EXT_MIX2,        P20_0,  14,     CTRL,	0x6F, 	LOG,	0)
...
OUTPUT_VIRT(VCF1_LEVEL,      VIRT,  	0,     	CTRL,	0x80, 	LOG,	0)
OUTPUT_VIRT(VCF2_LEVEL,      VIRT,  	0,     	CTRL,	0x81, 	LOG,	0)
OUTPUT_VIRT(CLEANF_LEVEL,    VIRT,  	0,     	CTRL,	0x82, 	LOG,	0)
OUTPUT_VIRT(VCF1_PAN,        VIRT,  	0,     	CTRL,	0x83, 	LIN,	0x8000)
OUTPUT_VIRT(VCF2_PAN,        VIRT,  	0,     	CTRL,	0x84, 	LIN,	0x8000)
OUTPUT_VIRT(CLEANF_PAN,      VIRT,  	0,     	CTRL,	0x85, 	LIN,	0x8000)
