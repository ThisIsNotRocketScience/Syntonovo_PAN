...
OUTPUT_VIRT(VCO1_LEVEL,		VIRT,  		0,     	CTRL,	0xD8, 	LOG,	0)
OUTPUT_VIRT(VCO2_LEVEL,		VIRT,  		0,      CTRL,	0xD9, 	LOG,	0)
OUTPUT_VIRT(VCO3_LEVEL,		VIRT,  		0,      CTRL,	0xDA, 	LOG,	0)
OUTPUT_VIRT(RM1_LEVEL,		VIRT,  		0,      CTRL,	0xDB, 	LOG,	0)
OUTPUT_VIRT(WHITENS_LEVEL,	VIRT,  		0,      CTRL,	0xDC, 	LOG,	0)
OUTPUT_VIRT(DIGINS_LEVEL,	VIRT,  		0,      CTRL,	0xDD, 	LOG,	0)
OUTPUT_VIRT(EXT_LEVEL,		VIRT,  		0,      CTRL,	0xDE, 	LOG,	0)
OUTPUT_VIRT(VCO4567_LEVEL,	VIRT,  		0,      CTRL,	0xDF, 	LOG,	0)
