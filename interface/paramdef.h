...
OUTPUT(VCO1_MIX1,		0,	0,	CTRL,	0x10,	CUSTOM,	0xffff)
OUTPUT(WHITENS_MIX1,	1,	0,	CTRL,	0x18,	CUSTOM,	0)
OUTPUT(VCO1_MIX2,		0,	1,	CTRL,	0x11,	CUSTOM,	0xffff)
...
OUTPUT(VCO7_PW,			5,	4,	CTRL,	0x32,	LIN,	0x7fff)
OUTPUT(VCO6_PW,			4,	5,	CTRL,	0x35,	LIN,	0x7fff)
//OUTPUT(PUN_MIX,			5,	5,	CTRL,	0x3D,	LOG,	0)
OUTPUT(VCO2SIN_MIX3,	5,	5,	CTRL,	0x71,	LOG,	0)
...
OUTPUT(VCF1_CV,			8,	6,	CTRL,	0x48,	INV,	0xffff)
...
OUTPUT_VIRT(VCF1_LEVEL, VIRT, 0, CTRL, 0x83, LOG, 0xffff)
...
OUTPUT_VIRT(MASTER_LEVEL, VIRT, 0, CTRL, 0x89, LIN, 0xFFFF)
...
//OUTPUT_VIRT(VCO1_LEVEL, VIRT, 0, CTRL, 0xD8, LIN, 0xffff)
//OUTPUT_VIRT(VCO2_LEVEL, VIRT, 0, CTRL, 0xD9, LIN, 0xffff)
//OUTPUT_VIRT(VCO3_LEVEL, VIRT, 0, CTRL, 0xDA, LIN, 0xffff)
//OUTPUT_VIRT(RM1_LEVEL, VIRT, 0, CTRL, 0xDB, LIN, 0xffff)
//OUTPUT_VIRT(WHITENS_LEVEL, VIRT, 0, CTRL, 0xDC, LIN, 0xffff)
//OUTPUT_VIRT(DIGINS_LEVEL, VIRT, 0, CTRL, 0xDD, LIN, 0xffff)
//OUTPUT_VIRT(EXT_LEVEL, VIRT, 0, CTRL, 0xDE, LIN, 0xffff)
//OUTPUT_VIRT(VCO4567_LEVEL, VIRT, 0, CTRL, 0xDF, LIN, 0xffff)

//OUTPUT_VIRT(DNSSAW_VCFMIX, VIRT, 0, CTRL, 0xF0, LIN, 0x8000)
//OUTPUT_VIRT(DNSSAW_LEVEL, VIRT, 0, CTRL, 0xF1, LIN, 0xffff)
