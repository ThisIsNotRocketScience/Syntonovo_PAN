...
CATEGORY(VCF1, "VCF1")
CATEGORY(VCF2, "VCF2")
CATEGORY(VCF2A, "VCF2 A")
CATEGORY(VCF2B, "VCF2 B")
CATEGORY(VCF2C, "VCF2 C")
CATEGORY(VCF2D, "VCF2 D")
...
SWITCH(SELVCF1MOST, 15, 0) // this is now headphone enable?
...
OUTPUT(VCO4567_MIX1,	1,	1,	CTRL,	0x19,	CUSTOM,	0, "VCO5678 -> VCF1", VCF2MIX)
OUTPUT(VCO1_SUB2,		0,	2,	CTRL,	0x12,	CUSTOM,	0,"VCO1 Sub -> VCF2", VCF2MIX)
OUTPUT(VCO4567_MIX2,	1,	2,	CTRL,	0x1A,	CUSTOM,	0,"VCO5678 -> VCF2", VCF1MIX)
...
OUTPUT(VCO6_DRY_MIX,	3,	4,	CTRL,	0x2C,	CUSTOM,	0, "VCO7 -> Cleanfeed", CLEANMIX)
OUTPUT(DIGINS_MIX2,		2,	5,	CTRL,	0x25,	CUSTOM,	0, "Digital Noise -> VCF2", VCF2MIX)
OUTPUT(VCO5_DRY_MIX,	3,	5,	CTRL,	0x2D,	CUSTOM,	0, "VCO6 -> Cleanfeed", CLEANMIX)
OUTPUT(RM1_MIX2,		2,	6,	CTRL,	0x26,	LOG,	0, "Ringmod -> VCF2", VCF2MIX)
OUTPUT(VCO7_DRY_MIX,	3,	6,	CTRL,	0x2E,	CUSTOM,	0, "VCO8 -> Cleanfeed", CLEANMIX)
OUTPUT(DIGINS_MIX1,		2,	7,	CTRL,	0x27,	CUSTOM,	0, "Digital Noise -> VCF1", VCF1MIX)
OUTPUT(VCO4_DRY_MIX,	3,	7,	CTRL,	0x2F,	CUSTOM,	0, "VCO5 -> Cleanfeed", CLEANMIX)
...
OUTPUT(VCO6_PW,			4,	5,	CTRL,	0x35,	LIN,	0x7fff, "Pulsewidth", VCO6)
...
OUTPUT(VCF2_A_MIX,		10,	0,	CTRL,	0x67,	CUSTOM,	0x7fff, "VCF2 A Mix", VCF2)
OUTPUT(CV_EXT_3,		11,	0,	CTRL,	0x68,	LIN,	0, "Output 3", EXTERNAL)
OUTPUT(VCF2_C_MIX,		10,	1,	CTRL,	0x64,	CUSTOM, 0x7fff, "VCF2 C Mix", VCF2)
...
OUTPUT(VCF2_D_MIX,		10,	3,	CTRL,	0x65,	CUSTOM, 0x7fff, "VCF2 D Mix", VCF2)
...
OUTPUT(VCF2_B_MIX,		10,	5,	CTRL,	0x59,	CUSTOM, 0x7fff, "VCF2 B Mix", VCF2)
...
SWITCH(SELVCF1AP, 30, 0)
SWITCH(SELVCF1BP, 29, 0)
SWITCH(SEL2TRI, 28, 0)
SWITCH(SEL2SAW, 27, 0)
SWITCH(SEL2SQR, 26, 1)
SWITCH(SEL2SUB, 25, 0)
...
OUTPUT(VCO3_MIX2,			0,	0,	CTRL,	0x1C,	CUSTOM,	0,	"VCO3 -> VCF2",	 VCF2MIX)
OUTPUT(DIGINS_MIX2,			1,	0,	CTRL,	0x25,	CUSTOM,	0,	"Digital Noise -> VCF2",	 VCF2MIX)
OUTPUT(VCO1_MIX2,			0,	1,	CTRL,	0x11,	CUSTOM,	0xffff,	"VCO1 -> VCF2",	 VCF2MIX)
OUTPUT(WHITENS_MIX2,		1,	1,	CTRL,	0x1B,	CUSTOM,	0,	"Whitenoise -> VCF2",	 VCF2MIX)
OUTPUT(VCO1_SUB2,			0,	2,	CTRL,	0x12,	CUSTOM,	0,	"VCO1 Sub -> VCF2",	 VCF2MIX)
OUTPUT(VCO4567_MIX2,		1,	2,	CTRL,	0x1A,	CUSTOM,	0,	"VCO5678 -> VCF2",	 VCF1MIX)
OUTPUT(VCO2_MIX2,			0,	3,	CTRL,	0x1F,	CUSTOM,	0,	"VCO2 -> VCF2",	 VCF2MIX)
OUTPUT(RM1_MIX2,			1,	3,	CTRL,	0x26,	LOG,	0,	"Ringmod -> VCF2",	 VCF2MIX)
OUTPUT(VCO1_SUB1,			0,	4,	CTRL,	0x13,	CUSTOM,	0,	"VCO1 Sub -> VCF1",	 VCF1MIX)
OUTPUT(WHITENS_MIX1,		1,	4,	CTRL,	0x18,	CUSTOM,	0,	"Whitenoise -> VCF1",	 VCF1MIX)
OUTPUT(VCO2_MIX1,			0,	5,	CTRL,	0x1E,	CUSTOM,	0,	"VCO2 -> VCF1",	 VCF1MIX)
OUTPUT(DIGINS_MIX1,			1,	5,	CTRL,	0x27,	CUSTOM,	0,	"Digital Noise -> VCF1",	 VCF1MIX)
OUTPUT(VCO1_MIX1,			0,	6,	CTRL,	0x10,	CUSTOM,	0xffff,	"VCO1 -> VCF1",	 VCF1MIX)
OUTPUT(RM1_MIX1,			1,	6,	CTRL,	0x24,	CUSTOM,	0,	"Ringmod -> VCF1",	 VCF1MIX)
OUTPUT(VCO3_MIX1,			0,	7,	CTRL,	0x1D,	CUSTOM,	0,	"VCO3 -> VCF1",	 VCF1MIX)
OUTPUT(VCO4567_MIX1,		1,	7,	CTRL,	0x19,	CUSTOM,	0,	"VCO5678 -> VCF1",	 VCF2MIX)
OUTPUT(VCO1_FREQ,			2,	0,	CTRL,	0x14,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(VCF2_A_RES,			3,	0,	CTRL,	0x49,	INV,	0,	"VCF2 A Resonance",	 VCF2)
OUTPUT(VCF1_CV,				2,	1,	CTRL,	0x48,	INV,	0xffff,	"Frequency",	 VCF1)
OUTPUT(VCO4_FREQ,			3,	1,	CTRL,	0x28,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(VCF1_RES,			2,	2,	CTRL,	0x4B,	LIN,	0,	"Resonance",	 VCF1)
OUTPUT(VCO4_PW,				3,	2,	CTRL,	0x2B,	LIN,	0x7fff,	"Pulsewidth",	 VCO4)
OUTPUT(VCO1_PW,				2,	3,	CTRL,	0x16,	LIN,	0x7fff,	"Pulsewidth",	 VCO1)
OUTPUT(VCF2_A_CV,			3,	3,	CTRL,	0x4A,	INV,	0x7fff,	"VCF2 A Frequency",	 VCF2)
OUTPUT(VCO4_DRY_MIX,		2,	4,	CTRL,	0x2F,	CUSTOM,	0,	"VCO5 -> Cleanfeed",	 CLEANMIX)
OUTPUT(VCO2_PW,				3,	4,	CTRL,	0x23,	LIN,	0x7fff,	"Pulsewidth",	 VCO2)
OUTPUT(VCO6_DRY_MIX,		2,	5,	CTRL,	0x2C,	CUSTOM,	0,	"VCO7 -> Cleanfeed",	 CLEANMIX)
OUTPUT(VCO3_FREQ,			3,	5,	CTRL,	0x21,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(VCO5_DRY_MIX,		2,	6,	CTRL,	0x2D,	CUSTOM,	0,	"VCO6 -> Cleanfeed",	 CLEANMIX)
OUTPUT(VCO3_PW,				3,	6,	CTRL,	0x22,	LIN,	0x7fff,	"Pulsewidth",	 VCO3)
OUTPUT(VCO7_DRY_MIX,		2,	7,	CTRL,	0x2E,	CUSTOM,	0,	"VCO8 -> Cleanfeed",	 CLEANMIX)
OUTPUT(VCO2_FREQ,			3,	7,	CTRL,	0x20,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(VCF1_CROSSMOD,		4,	0,	CTRL,	0x4E,	INV,	0,	"Cross modulation",	 VCF1)
OUTPUT(VCO3SIN_MIX3,		5,	0,	CTRL,	0x72,	LOG,	0,	"VCO3 sine -> Cleanfeed",	 CLEANMIX)
OUTPUT(VCF2_R_LOG,			4,	1,	INT,	0x30,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(BN_MIX3,				5,	1,	CTRL,	0x3F,	LOG,	0,	"Brownnoise -> Cleanfeed",	 CLEANMIX)
OUTPUT(VCF2_L_LOG,			4,	2,	INT,	0x34,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(VCO2SIN_MIX3,		5,	2,	CTRL,	0x71,	LOG,	0,	"VCO2 sine -> Cleanfeed",	 CLEANMIX)
OUTPUT(VCF2_CROSSMOD,		4,	3,	CTRL,	0x4C,	INV,	0,	"Cross modulation",	 VCF2)
OUTPUT(DNSSAW_MIX2,			5,	3,	CTRL,	0x74,	CUSTOM,	0,	"Digital noise sawtooth -> VCF2",	 VCF2MIX)
OUTPUT(VCF2_B_RES,			4,	4,	CTRL,	0x51,	INV,	0,	"VCF2 B Resonance",	 VCF2)
OUTPUT(VCF2_FX_R,			5,	4,	CTRL,	0x33,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(VCO5_FREQ,			4,	5,	CTRL,	0x2A,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(DNSSAW_MIX1,			5,	5,	CTRL,	0x73,	CUSTOM,	0,	"Digital noise sawtooth -> VCF1",	 VCF1MIX)
OUTPUT(VCO5_PW,				4,	6,	CTRL,	0x29,	LIN,	0x7fff,	"Pulsewidth",	 VCO5)
OUTPUT(VCO1SIN_MIX3,		5,	6,	CTRL,	0x70,	LOG,	0,	"VCO1 sine -> Cleanfeed",	 CLEANMIX)
OUTPUT(VCF2_B_CV,			4,	7,	CTRL,	0x52,	INV,	0x7fff,	"VCF2 B Frequency",	 VCF2)
OUTPUT(VCF2_FX_L,			5,	7,	CTRL,	0x36,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(CLEANF_R_LOG,		6,	0,	INT,	0x42,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(VCF2_C_CV,			7,	0,	CTRL,	0x54,	INV,	0x7fff,	"VCF2 C Frequency",	 VCF2)
OUTPUT(RM2_MIX3,			6,	1,	CTRL,	0x39,	CUSTOM,	0,	"Ringmod 2 -> Cleanfeed",	 CLEANMIX)
OUTPUT(VCF2_C_RES,			7,	1,	CTRL,	0x56,	INV,	0,	"VCF2 C Resonance",	 VCF2)
OUTPUT(PUN_MIX,				6,	2,	CTRL,	0x3D,	LOG,	0,	"Purplenoise -> Cleanfeed",	 CLEANMIX)
OUTPUT(VCO123_FM2,			7,	2,	CTRL,	0x17,	INV,	0,	"FM level",	 VCO2)
OUTPUT(CLEANF_L_LOG,		6,	3,	INT,	0x46,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(VCO123_FM3,			7,	3,	CTRL,	0x15,	INV,	0,	"FM level",	 VCO3)
OUTPUT(VCF1_FX_12,			6,	4,	CTRL,	0x38,	CUSTOM,	0,	"FX 24",	 VCF1)
OUTPUT(VCF1_R_LIN,			7,	4,	INT,	0x47,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(VCF1_L_LOG,			6,	5,	INT,	0x3C,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(CLEANF_FX_L,			7,	5,	CTRL,	0x40,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(VCF1_FX_24,			6,	6,	CTRL,	0x3B,	CUSTOM,	0,	"FX 24",	 VCF1)
OUTPUT(VCF1_L_LIN,			7,	6,	INT,	0x44,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(VCF1_R_LOG,			6,	7,	INT,	0x3E,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(CLEANF_FX_R,			7,	7,	CTRL,	0x43,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(VCF2_D_CV,			8,	0,	CTRL,	0x5F,	INV,	0x7fff,	"VCF2 D Frequency",	 VCF2)
OUTPUT(VCF2_B_MIX,			9,	0,	CTRL,	0x59,	CUSTOM,	 0x7fff,	"VCF2 B Mix",	 VCF2)
OUTPUT(VCO7_PW,				8,	1,	CTRL,	0x32,	LIN,	0x7fff,	"Pulsewidth",	 VCO7)
OUTPUT(GATETRIG_MIX2,		9,	1,	CTRL,	0x8D,	CUSTOM,	0,	"GateTrig -> VCF2",	 VCF2MIX)
OUTPUT(VCF2_M_FB,			8,	2,	CTRL,	0x53,	LIN,	0,	"M Feedback",	VCF2)
OUTPUT(CLEANF_R_LIN,		9,	2,	INT,	0x5E,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(VCF2_P_FB,			8,	3,	CTRL,	0x50,	LIN,	0,	"P Feedback",	 VCF2)
OUTPUT(CLEANF_L_LIN,		9,	3,	INT,	0x5C,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(VCO7_FREQ,			8,	4,	CTRL,	0x31,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(VCF2_D_MIX,			9,	4,	CTRL,	0x65,	CUSTOM,	0x7fff,	"VCF2 D Mix",	 VCF2)
OUTPUT(VCF2_D_RES,			8,	5,	CTRL,	0x5D,	INV,	0,	"VCF2 D Resonance",	 VCF2)
OUTPUT(VCF2_C_MIX,			9,	5,	CTRL,	0x64,	CUSTOM,	0x7fff,	"VCF2 C Mix",	 VCF2)
OUTPUT(VCO6_PW,				8,	6,	CTRL,	0x35,	LIN,	0x7fff,	"Pulsewidth",	 VCO6)
OUTPUT(VCF2_A_MIX,			9,	6,	CTRL,	0x67,	CUSTOM,	0x7fff,	"VCF2 A Mix",	 VCF2)
OUTPUT(VCO6_FREQ,			8,	7,	CTRL,	0x37,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(NOISE_COLOR,			9,	7,	CTRL,	0x41,	CUSTOM,	0,	"Noise color",	 VCO8)
OUTPUT(MASTER_LEVEL,		10,	0,	CTRL,	0x89,	LOG,	0xC000,	"",	IGNORE)
OUTPUT(CV_EXT_4,			11,	0,	CTRL,	0x6B,	LIN,	0,	"Output 4",	 EXTERNAL)
OUTPUT(VCA_FXPOT1,			10,	1,	CTRL,	0x58,	LIN,	0,	"Parameter 1",	 FX)
OUTPUT(CV_EXT_6,			11,	1,	CTRL,	0x69,	LIN,	0,	"Output 6",	 EXTERNAL)
OUTPUT(VCA_FXPOT2,			10,	2,	CTRL,	0x5B,	LIN,	0,	"Parameter 2",	 FX)
OUTPUT(CV_EXT_5,			11,	2,	CTRL,	0x6A,	LIN,	0,	"Output 5",	 EXTERNAL)
OUTPUT(HEADPHONE_LEVEL,		10,	3,	CTRL,	0x8E,	LOG,	0xC000,	"",	IGNORE)
OUTPUT(CV_EXT_3,			11,	3,	CTRL,	0x68,	LIN,	0,	"Output 3",	 EXTERNAL)
OUTPUT(VCF2_R_LIN,			10,	4,	INT,	0x6F,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(CV_EXT_KB,			11,	4,	CTRL,	0x6D,	LIN,	0,	"KB",	 EXTERNAL)
OUTPUT(VCF2_L_LIN,			10,	5,	INT,	0x66,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(CV_EXT_2,			11,	5,	CTRL,	0x6E,	LIN,	0,	"Output 2",	 EXTERNAL)
OUTPUT(FX_L_RETURN,			10,	6,	CTRL,	0x55,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(CV_EXT_1,			11,	6,	CTRL,	0x6C,	LIN,	0,	"Output 1",	 EXTERNAL)
OUTPUT(FX_R_RETURN,			10,	7,	CTRL,	0x57,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(VCA_FXPOT3,			11,	7,	CTRL,	0x5A,	LIN,	0,	"Parameter 3",	 FX)
...
OUTPUT_VIRT(FX_RET_LEVEL, VIRT, 0, CTRL, 0x8A, LOG, 0x6000,"FX Level", MASTERMIX)
//OUTPUT_VIRT(FX_RET_PAN, VIRT, 0, CTRL, 0x8B, LIN, 0x8000,"FX Pan", MASTERMIX)
...
OUTPUT_VIRT(ZONE1NOTE1, VIRT, 0, CTRL, 0x100, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE1NOTE2, VIRT, 0, CTRL, 0x101, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE1NOTE3, VIRT, 0, CTRL, 0x102, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE1NOTE4, VIRT, 0, CTRL, 0x103, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE1NOTE5, VIRT, 0, CTRL, 0x104, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE1NOTE6, VIRT, 0, CTRL, 0x105, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE1NOTE7, VIRT, 0, CTRL, 0x106, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE1NOTE8, VIRT, 0, CTRL, 0x107, CUSTOM, 0,"",IGNORE)

OUTPUT_VIRT(ZONE2NOTE1, VIRT, 0, CTRL, 0x110, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE2NOTE2, VIRT, 0, CTRL, 0x111, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE2NOTE3, VIRT, 0, CTRL, 0x112, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE2NOTE4, VIRT, 0, CTRL, 0x113, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE2NOTE5, VIRT, 0, CTRL, 0x114, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE2NOTE6, VIRT, 0, CTRL, 0x115, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE2NOTE7, VIRT, 0, CTRL, 0x116, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE2NOTE8, VIRT, 0, CTRL, 0x117, CUSTOM, 0,"",IGNORE)

OUTPUT_VIRT(ZONE3NOTE1, VIRT, 0, CTRL, 0x120, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE3NOTE2, VIRT, 0, CTRL, 0x121, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE3NOTE3, VIRT, 0, CTRL, 0x122, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE3NOTE4, VIRT, 0, CTRL, 0x123, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE3NOTE5, VIRT, 0, CTRL, 0x124, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE3NOTE6, VIRT, 0, CTRL, 0x125, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE3NOTE7, VIRT, 0, CTRL, 0x126, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE3NOTE8, VIRT, 0, CTRL, 0x127, CUSTOM, 0,"",IGNORE)

OUTPUT_VIRT(ZONE4NOTE1, VIRT, 0, CTRL, 0x130, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE4NOTE2, VIRT, 0, CTRL, 0x131, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE4NOTE3, VIRT, 0, CTRL, 0x132, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE4NOTE4, VIRT, 0, CTRL, 0x133, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE4NOTE5, VIRT, 0, CTRL, 0x134, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE4NOTE6, VIRT, 0, CTRL, 0x135, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE4NOTE7, VIRT, 0, CTRL, 0x136, CUSTOM, 0,"",IGNORE)
OUTPUT_VIRT(ZONE4NOTE8, VIRT, 0, CTRL, 0x137, CUSTOM, 0,"",IGNORE)
...
OUTPUT_VIRT(GATE1, VIRT, 0, CTRL, 0x140, CUSTOM, 0, "", IGNORE)
OUTPUT_VIRT(GATE2, VIRT, 0, CTRL, 0x141, CUSTOM, 0, "", IGNORE)
OUTPUT_VIRT(GATE3, VIRT, 0, CTRL, 0x142, CUSTOM, 0, "", IGNORE)
OUTPUT_VIRT(GATE4, VIRT, 0, CTRL, 0x143, CUSTOM, 0, "", IGNORE)
OUTPUT_VIRT(RETRIGGER1, VIRT, 0, CTRL, 0x144, CUSTOM, 0, "", IGNORE)
OUTPUT_VIRT(RETRIGGER2, VIRT, 0, CTRL, 0x145, CUSTOM, 0, "", IGNORE)
OUTPUT_VIRT(RETRIGGER3, VIRT, 0, CTRL, 0x146, CUSTOM, 0, "", IGNORE)
OUTPUT_VIRT(RETRIGGER4, VIRT, 0, CTRL, 0x147, CUSTOM, 0, "", IGNORE)

OUTPUT_VIRT(MASTER_PITCH, VIRT, 0, CTRL, 0xEA, LIN, 0x8000, "Master pitch", VCO1)
...
OUTPUT_VIRT(VCO1_COARSE, VIRT, 0, CTRL, 0xD8, LIN, 0x8000, "", IGNORE)
OUTPUT_VIRT(VCO2_COARSE, VIRT, 0, CTRL, 0xD9, LIN, 0x8000, "", IGNORE)
OUTPUT_VIRT(VCO3_COARSE, VIRT, 0, CTRL, 0xDA, LIN, 0x8000, "", IGNORE)
OUTPUT_VIRT(VCO4_COARSE, VIRT, 0, CTRL, 0xDB, LIN, 0x8000, "", IGNORE)
OUTPUT_VIRT(VCO5_COARSE, VIRT, 0, CTRL, 0xDC, LIN, 0x8000, "", IGNORE)
OUTPUT_VIRT(VCO6_COARSE, VIRT, 0, CTRL, 0xDD, LIN, 0x8000, "", IGNORE)
OUTPUT_VIRT(VCO7_COARSE, VIRT, 0, CTRL, 0xDE, LIN, 0x8000, "", IGNORE)
OUTPUT_VIRT(VCO8_COARSE, VIRT, 0, CTRL, 0xDF, LIN, 0x8000, "", IGNORE)
