...
OUTPUT(VCF2_L_MIX,      P12_3,  5,      CTRL,	0x26, 	CUSTOM,	0)
OUTPUT(VCF2_M1_MIX,     P12_3,  6,      CTRL,	0x27, 	CUSTOM,	0)
OUTPUT(VCF2_M2_MIX,     P12_3,  7,      CTRL,	0x28, 	CUSTOM,	0)
OUTPUT(VCF2_H_MIX,      P12_3,  8,      CTRL,	0x29, 	CUSTOM,	0)
...
SWITCH(SELPORTAMENTO, 32)
SWITCH(SELSTACCATO, 33)

SWITCH(SELSTASHOSC4567, 34)
SWITCH(SELSTASHVCF2, 35)

SWITCH(SELCHASEOSC4567, 36)
SWITCH(SELCHASEVCF2, 37)

// global sustain -> keep gate open
SWITCH(SELSUSTAINL, 38)
SWITCH(SELSUSTAINR, 39)
