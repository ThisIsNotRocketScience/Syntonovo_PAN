...
OUTPUT(VCA_FINAL,		4,	1,	CTRL,	0x8A,	LOG,	0)
...
OUTPUT(VCF1_CROSSMOD,	7,	1,	CTRL,	0x4E,	LIN,	0)
...
OUTPUT(VCF2_CROSSMOD,	7,	2,	CTRL,	0x4C,	LIN,	0)
...
OUTPUT(RM2_MIX3,		6,	5,	CTRL,	0x39,	LOG,	0)
...
OUTPUT(FX_L_RETURN,		8,	4,	CTRL,	0x55,	CUSTOM,	0)
//OUTPUT(CLEANF_L_LIN,	9,	4,	INT,	0x5C,	CUSTOM,	0)
OUTPUT(VCF2_M1_RES,		9,	4,	CTRL,	0x51,	INV,	0)
//OUTPUT(FX_L_RETURN,		8,	5,	CTRL,	0x55,	CUSTOM,	0)
OUTPUT(VCF1_RES,		8,	5,	CTRL,	0x4B,	LIN,	0)
//OUTPUT(VCF2_H_RES,		9,	5,	CTRL,	0x5D,	INV,	0)
OUTPUT(VCF2_M1_CV,		9,	5,	CTRL,	0x52,	INV,	0x7fff)
//OUTPUT(VCF2_M2_RES,		8,	6,	CTRL,	0x56,	INV,	0)
OUTPUT(VCF1_CV,			8,	6,	CTRL,	0x48,	LIN,	0)
