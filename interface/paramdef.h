...
OUTPUT(VCO3_PW,				3,	4,	CTRL,	0x22,	LIN,	0x7fff,	"Pulsewidth",	 VCO3)
OUTPUT(VCO6_DRY_MIX,		2,	5,	CTRL,	0x2C,	CUSTOM,	0,	"VCO7 -> Cleanfeed",	 CLEANMIX)
OUTPUT(VCO2_FREQ,			3,	5,	CTRL,	0x20,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(VCO5_DRY_MIX,		2,	6,	CTRL,	0x2D,	CUSTOM,	0,	"VCO6 -> Cleanfeed",	 CLEANMIX)
OUTPUT(VCO3_FREQ,			3,	6,	CTRL,	0x21,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(VCO7_DRY_MIX,		2,	7,	CTRL,	0x2E,	CUSTOM,	0,	"VCO8 -> Cleanfeed",	 CLEANMIX)
OUTPUT(VCO2_PW,				3,	7,	CTRL,	0x23,	LIN,	0x7fff,	"Pulsewidth",	 VCO2)
...
OUTPUT(VCO5_PW,				4,	4,	CTRL,	0x29,	LIN,	0x7fff,	"Pulsewidth",	 VCO5)
OUTPUT(VCO1SIN_MIX3,		5,	4,	CTRL,	0x70,	LOG,	0,	"VCO1 sine -> Cleanfeed",	 CLEANMIX)
OUTPUT(VCF2_B_CV,			4,	5,	CTRL,	0x52,	INV,	0x7fff,	"VCF2 B Frequency",	 VCF2)
OUTPUT(VCF2_FX_L,			5,	5,	CTRL,	0x36,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(VCO5_FREQ,			4,	6,	CTRL,	0x2A,	CUSTOM,	0,	"",	 IGNORE)
OUTPUT(DNSSAW_MIX1,			5,	6,	CTRL,	0x73,	CUSTOM,	0,	"Digital noise sawtooth -> VCF1",	 VCF1MIX)
OUTPUT(VCF2_B_RES,			4,	7,	CTRL,	0x51,	INV,	0,	"VCF2 B Resonance",	 VCF2)
OUTPUT(VCF2_FX_R,			5,	7,	CTRL,	0x33,	CUSTOM,	0,	"",	 IGNORE)
...
OUTPUT(VCF2_D_MIX,			9,	0,	CTRL,	0x65,	CUSTOM,	0x7fff,	"VCF2 D Mix",	 VCF2)
...
OUTPUT(VCF2_B_MIX,			9,	4,	CTRL,	0x59,	CUSTOM,	 0x7fff,	"VCF2 B Mix",	 VCF2)
...
OUTPUT(CV_EXT_3,			11,	0,	CTRL,	0x68,	LIN,	0,	"Output 3",	 EXTERNAL)
OUTPUT(VCA_FXPOT2,			10,	1,	CTRL,	0x58,	LIN,	0,	"Parameter 1",	 FX)
OUTPUT(CV_EXT_6,			11,	1,	CTRL,	0x69,	LIN,	0,	"Output 6",	 EXTERNAL)
OUTPUT(VCA_FXPOT1,			10,	2,	CTRL,	0x5B,	LIN,	0,	"Parameter 2",	 FX)
OUTPUT(CV_EXT_5,			11,	2,	CTRL,	0x6A,	LIN,	0,	"Output 5",	 EXTERNAL)
