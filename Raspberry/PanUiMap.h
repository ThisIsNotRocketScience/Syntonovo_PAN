...
CUSTOMENTRY("Sync from VCO3", MenuEntry_Toggle, Switch_SELVCOSYNC3)
...
CUSTOMENTRY("Sync from VCO1", MenuEntry_Toggle, Switch_SELVCOSYNC1)
...
CUSTOMENTRY("Sync from VCO2", MenuEntry_Toggle, Switch_SELVCOSYNC2)
...
SKIPENTRY
ENTRY("FM (from VCO2)", MenuEntry_Value, Output_VCO123_FM3)
SKIPENTRY
...
MENU(VCO8, ledbutton_VCO3, "Digital Noise")
CUSTOMENTRY("KeyZone", MenuEntry_Action, MenuAction_KeyZone)
...
ENTRY("VCO123 Sub", MenuEntry_Value, Output_VCO1_SUB1)
ENTRY("RM VCO 2/3", MenuEntry_Value, Output_RM1_MIX1)
ENTRY("VCO4567 Pulse", MenuEntry_Value, Output_VCO4567_MIX1)
ENTRY("DNoise", MenuEntry_Value, Output_DIGINS_MIX1)
ENTRY("DN Saw", MenuEntry_Value, Output_DNSSAW_MIX1)
...
ENTRY("VCO123 Sub", MenuEntry_Value, Output_VCO1_SUB2)
ENTRY("RM VCO 2/3", MenuEntry_Value, Output_RM1_MIX2)
ENTRY("VCO4567 Pulse", MenuEntry_Value, Output_VCO4567_MIX2)
ENTRY("DNoise", MenuEntry_Value, Output_DIGINS_MIX2)
ENTRY("DN Saw", MenuEntry_Value, Output_DNSSAW_MIX2)
ENTRY("Whitenoise", MenuEntry_Value, Output_WHITENS_MIX2)
ENTRY("Gatetrigger", MenuEntry_Value, Output_RM1_MIX2)
