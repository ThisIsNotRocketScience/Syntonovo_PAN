...
LEDBUTTON(OctUpLeft, 40, 161,40, "OctUp L", 1, 0.9f, 0)
LEDBUTTON(OctDownLeft, 40, 181,41, "OctDown L", 1, 0.9f, 0)
LEDBUTTON(PortamentoLeft, 50, 170,42, "Portamento L", 1, 0.9f, 0)

LEDBUTTON(OctUpRight, 520, 161,43, "OctUp R", 1, 0.9f, 0)
LEDBUTTON(OctDownRight, 520, 181,44, "OctDown R", 1, 0.9f, 0)
LEDBUTTON(PortamentoRight, 500, 170,45, "Portamento R", 1, 0.9f, 0)
