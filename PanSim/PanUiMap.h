...
TARGET(Output_VCO123_FM2, ledbutton_VCO1, knob_FM_1_to_2, "FM1")
TARGET(Output_VCO123_FM3, ledbutton_VCO2, knob_FM_2_to_3, "FM2")
...
CUSTOMENTRY("Sqr", MenuEntry_Toggle, Switch_SEL4SQR)
