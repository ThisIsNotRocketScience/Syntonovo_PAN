...
TARGET(Output_CLEANF_LEVEL, __LEDBUTTON_COUNT, knob_LEVEL_Cleanfeed, "")
TARGET(Output_VCF1_LEVEL, __LEDBUTTON_COUNT, knob_LEVEL_VCF1, "")
TARGET(Output_VCF2_LEVEL, __LEDBUTTON_COUNT, knob_LEVEL_VCF2, "")
...
CUSTOMENTRY("Wave", MenuEntry_Waveform3, Switch_SEL1TRI)
...
CUSTOMENTRY("Wave", MenuEntry_Waveform3, Switch_SEL2TRI)
...
CUSTOMENTRY("Wave", MenuEntry_Waveform3, Switch_SEL3TRI)
...
CUSTOMENTRY("Wave", MenuEntry_Waveform1, Switch_SEL4SAW)
...
CUSTOMENTRY("Wave", MenuEntry_Waveform1, Switch_SEL5SAW)
ENTRY("VCFMix", MenuEntry_FilterMix, Output_VCO4567_VCFMIX)
ENDMENU()

MENU(VCO6, ledbutton_VCO6, "VCO6")
ENTRY("Pitch", MenuEntry_Pitch, Output_VCO6_PITCH)
CUSTOMENTRY("Wave", MenuEntry_Waveform1, Switch_SEL6SAW)
ENTRY("VCFMix", MenuEntry_FilterMix, Output_VCO4567_VCFMIX)
ENDMENU()

MENU(VCO7, ledbutton_VCO7, "VCO7")
ENTRY("Pitch", MenuEntry_Pitch, Output_VCO7_PITCH)
CUSTOMENTRY("Wave", MenuEntry_Waveform1, Switch_SEL7SAW)
ENTRY("VCFMix", MenuEntry_FilterMix, Output_VCO4567_VCFMIX)
ENDMENU()
