...
CUSTOMENTRY("CleanfeedFX", MenuEntry_Toggle, Switch_SELEFFECT1)
CUSTOMENTRY("VCF 1 FX", MenuEntry_Toggle, Switch_SELEFFECT2)
CUSTOMENTRY("VCF 2 FX", MenuEntry_Toggle, Switch_SELEFFECT3)
ENDMENU()
