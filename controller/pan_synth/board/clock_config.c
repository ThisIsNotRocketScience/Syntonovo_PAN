...
outputs:
- {id: AUDPLL_clock.outFreq, value: 64 MHz}
- {id: FRO12M_clock.outFreq, value: 12 MHz}
- {id: FROHF_clock.outFreq, value: 48 MHz}
- {id: FXCOM1_clock.outFreq, value: 64 MHz}
- {id: FXCOM2_clock.outFreq, value: 64 MHz}
- {id: FXCOM3_clock.outFreq, value: 64 MHz}
- {id: FXCOM5_clock.outFreq, value: 64 MHz}
- {id: FXCOM6_clock.outFreq, value: 64 MHz}
- {id: FXCOM7_clock.outFreq, value: 64 MHz}
- {id: FXCOM8_clock.outFreq, value: 64 MHz, locked: true, accuracy: '0.001'}
...
- {id: SYSCON.AUD_M_MULT.scale, value: '128'}
